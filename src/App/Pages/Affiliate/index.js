    ...
    render(){
        ...
        return(
            <>
                ...
                <div style={{ background: 'rgb(108 108 229) url(/assets/images/mountain.png)', backgroundSize: 'cover'}} className={'p-4 wheel-content'}>
                    <Terms/>
                    ...
                    <Row>
                        <Col sm={12} xl={5} md={5} className={'m-auto'}>
                            <Card>
                                <Card.Body className={'rounded text-center'} style={{ background: "rgb(108 108 229)" }}>
                                    <label className="text-white text-upper">Your Link</label>
                                    { logged ?

                                        <input type="text" value={SITE + '/aff/' + this.state.token} readOnly className={'form-control'} style={{ background: "#47478e" }} />
                                        :
                                        <input type="text" value={"Please login to see your link."} readOnly className={'form-control'} style={{ background: "#47478e" }} />
                                    }
                                </Card.Body>
                            </Card>
                        </Col>
