...
class Register extends Component {
  ...
  submitForm(e) {
    ...
    if (username.length < 5) {
      this.setState({
        status: t("please_enter_username_more_than_5_words"),
        disabled: false,
      });
      return;
    }
    ...
    if (!ruleChecked) {
      this.setState({
        status: "Please accept user agreement and age rule check",
        disabled: false,
      });
      return;
    }
          ...
          <div className="card mb-2">
            <div className="card-body p-1">
              <h2 className={"text-center mb-2 pb-2 hdr flex"}>
                ...
                {/* Replace the back button with a link */}
                {/* <span onClick={this.goBack} className="cpt hvw" title="go back">
                  <i className="fa fa-chevron-left font-20 aligdsn-top ml-3 mr-2 mt-1" />
                </span> */}
                <span className="flex-1">
                  <span className="linear-cl">Register</span>
                </span>
              </h2>
                ...
                <div className="px-3">
                  ...
                  >
                    ...
                    <div className="form-group mb-2">
                      <div className="input-group">
                        <div className="input-group-append">
                          <span className="input-group-text bgin">
                            {t("username")}
                          </span>
                        </div>
                        <input
                    ...
                    {status && (
                      <div
                        className={
                          "alert bg-secondary text-white mt-2 mb-0 flex"
                        }
                      >
