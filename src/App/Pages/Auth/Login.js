                ...
                <div className={"m-auto " + cls}>
                    <div className="card mb-2">
                        <div className="card-body p-1">
                            ...
                            <form className={"form-horizontal " + form_cls} onSubmit={ (e) => { this.handleSubmit(e) }}>
                                <div className={"m-auto min-form"}>
                                {mobile ?
                                    <>
                                        <FormInputs t={t} mobile={mobile} handleChange={this.handleChange} handleShowPass={this.handleShowPass} state={this.state} />
                                        ...
                                        <div className="text-center mb-3 like-row">
                                            ...
                                            <div className="my-1 text-right txt-clip">
                                                <Link to={'/forgot_password'} className="btn btn-link txt-clip">Forgot Password?</Link>
                                            </div>
                                        </div>
                                    </>
                                :
                                     <>
                                         ...
                                         <div className="like-row m-1">
                                             ...
                                             <div className="text-right">
                                                 <button className="btn btn-primary btn-block font-weight-bold no-shadow" disabled={this.state.disabled}>
                                                     <i className="mdi mdi-login mr-1 float-left font-18" /> {t('login')}
                                                 </button>
                                             </div>
                                         </div>
                                     </>
            ...
            <>
                {mobile ?
                    <h2 className={'text-center mb-2 pb-2 hdr flex'}>
                        ...
                        <span className="flex-1"><span className="linear-cl">User Login</span></span>
                    </h2>
                :
                    <></>
                }
