                    ...
                    <div className="card mb-2">
                        <div className="card-body p-1">
                            <h2 className={'text-center mb-2 pb-2 hdr flex'}>
                                ...
                                <span className="flex-1"><span className="linear-cl">Forgot Password</span></span>
                            </h2>
                                ...
                                <div className="px-3">
                                    ...
                                    <form className="my-4" onSubmit={ (e) => this.submitForm(e)} >
                                        ...
                                        <div className="form-group mt-2 text-center">
                                            <button type="submit" className="btn btn-primary btn-block font-weight-bold no-shadow" disabled={disabled}>
