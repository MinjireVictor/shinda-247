...
class Help extends Component{
    ...
    render() {
        ...
        return(
            <>
                <span onClick={this.handleShow} className="btn btn-link cpt hvw txt-clip" data-tip={type === 'min' ? 'Help' : ''}>
                    <i className={'fa fa-question-circle mr-1'} />
                    {type !== 'min' && <span>Help</span>}
                </span>
                <Modal
                    size="md"
					backdrop="static"
                ...
                >
                    <Modal.Header className="Header">
                        <span className="linear-cl">Help</span>
                    ...
                    <Modal.Body className="modal-helper">
                        ...
                        <p className={'font-light text-b2'}>
                            ...
                            <code>md5(HASH)</code>
                            <br/>
                            <a target="_blank" rel="noopener noreferrer" href="https://emn178.github.io/online-tools/md5.html">Here is a simple tool (click)</a>, put the <span className="text-success">HASH</span> value then you can see <span className="text-warning">md5</span> value.
                        </p>
                    </Modal.Body>
                </Modal>
            </>
