  ...
  render() {
    ...
    return (
      <>
        <ReactTooltip />
        <li
          className="dropdown notification-list user-dropdown"
...
function Slide() {
  ...
  const list = (anchor) => (
    <>
      <h6 className="dropdown-item-text px-2 nttitle">Notifications</h6>
      <div
        className={clsx(classes.list, { anchor })}
        role="presentation"
  ...
  return (
    <div>
      <React.Fragment key={anchor}>
        <button
          className="dropdown-toggle dropdown-toggle-split btn btn-user mt-0 py-1-5 notif-btn"
