...
import {__, encode, forceSatoshiFormat, wait, sendNotfication, Event} from "../../../../Helper";
...
class Details extends React.Component {
    ...
    render() {
        let { currentCoin, lowProfit, highProfit, name, color, chart, since, avatar, profit, date, _token, level, played, wined, medal } = this.state;
            ...
            <>
                {
                    ...
                    <div className={ "animated fadeIn medals-view" }>
                        ...
                        <div class="media mb-2">
                            <img src="/assets/images/badges/badge-2.svg" alt="" height="60" class="mr-3" />
                        ...
                        <div class="media mb-2">
                            <img src="/assets/images/badges/badge-3.svg" alt="" height="60" class="mr-3" />
                            <div class="media-body align-self-center">  
                                <div class="mb-2">
                                    <span class="badge badge-purple px-3">Deposit</span>
                                </div>
                        ...
                        <div class="media mb-2">
                            <img src="/assets/images/badges/badge-7.svg" alt="" height="45" class="mr-3" />
                            <div class="media-body align-self-center">  
                                <div class="mb-2">
                                    <span class="badge badge-purple px-3">Deposit</span>
                                </div>
                        ...
                        <div class="media mb-2">
                            <img src="/assets/images/badges/badge-6.svg" alt="" height="60" class="mr-3" />
                            <div class="media-body align-self-center">  
                                <div class="mb-2">
                        ...
                        <div class="media my-2">
                            <img src="/assets/images/badges/badge-8.svg" alt="" height="60" class="mr-3" />
                            <div class="media-body align-self-center">  
                                <div class="mb-2">
                                ...
                                <Card className="mt-2 mb-1">
                                    <Card.Body onClick={this.toggleMedalView} className="p-1 medals text-center cpt">
                                        ...
                                        <div className="img-group text-center">
                                            <ReactTooltip />
                                            <img data-tip="BGame User" className="img-fluid mx-1 active" src="/assets/images/badges/badge-1.svg" alt="" />
                                            {medal === 1 ?
                                                <img data-tip={"Deposited Below 100 USD"} className={"img-fluid mx-1 active"} src="/assets/images/badges/badge-2.svg" alt="" />
                                                :
                                                <img className={"img-fluid mx-1"} src="/assets/images/badges/badge-2.svg" alt="" />
                                            }

                                            {medal === 2 ?
                                                <img data-tip={"Deposited Below 500 USD"} className={"img-fluid mx-1 active"} src="/assets/images/badges/badge-3.svg" alt="" />
                                                :
                                                <img className={"img-fluid mx-1"} src="/assets/images/badges/badge-3.svg" alt="" />
                                            }
                                            {medal === 3 ?
                                                <img data-tip={"Deposited Below 2000 USD"} className={"img-fluid mx-1 active"} src="/assets/images/badges/badge-7.svg" alt="" />
                                                :
                                                <img className={"img-fluid mx-1"} src="/assets/images/badges/badge-7.svg" alt="" />
                                            }
                                            <img className={ "img-fluid mx-1" } src="/assets/images/badges/badge-6.svg" alt="" />
                                            <img className={ "img-fluid mx-1" } src="/assets/images/badges/badge-8.svg" alt="" />
                                        </div>
                                    </Card.Body>
                                </Card>
                            </Col>
                                ...
                                <Col lg="6" md="6" className="col-6">
                                    <Card className={'mb-1 brd15'}>
                                        <Card.Body className="p-1">
                                            ...
                                            :
                                                <><img className="mini-coin-9" src={'/assets/images/' + __.upperCase(currentCoin) + '.png'} alt="" />
