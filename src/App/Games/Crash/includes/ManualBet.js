...
import {__, isValidNumber, forceSatoshiFormat, User, Game, sendNotfication} from "../../../../Helper";
...
class ManualBet extends Component {
    ...
    handleBet(e){
        if(this._isMounted){
           ...
           // Check User
            if(!token){
                return sendNotfication('please login in first to be able to place a bet', 'warning', 'top-right');
