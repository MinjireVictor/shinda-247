...
class Bet extends React.Component {
  ...
  render() {
    ...
    let { token, mobile, isLoggedIn } = this.props;
    ...
    return (
      ...
      <div style={{ width: "100%", overFlow: "hidden" }}>
        <div style={{ width: "100%", overFlow: "hidden" }}>
            ...
            >
              ...
              <div
                style={{
                  width: "100px",
                  height: "5px",
                  backgroundColor: `${value !== 0 ? `#00000000` : `#EDA562`}`,
                  color: "#fff",
                  marginLeft: "2px",
                  marginRight: "2px",
                }}
            ...
            >
              ...
              <div
                style={{
                  width: "100px",
                  height: "5px",
                  backgroundColor: `${value !== 1 ? `#00000000` : `#EDA562`}`,
                  color: "#fff",
                  marginLeft: "2px",
                  marginRight: "2px",
                }}
            ...
            >
              ...
              <div
                style={{
                  width: "100px",
                  height: "5px",
                  backgroundColor: `${value !== 2 ? `#00000000` : `#EDA562`}`,
                  color: "#fff",
                  marginLeft: "2px",
                  marginRight: "2px",
                }}
          ...
          >
            <div>
              <ManualBet token={token} mobile={mobile} isLogged={isLoggedIn} />
            </div>
            <div style={{ minHeight: "200px" }}>
              <AutoBet isLogged={isLoggedIn} />
            </div>
            <div>
              <JackPot />
            </div>
